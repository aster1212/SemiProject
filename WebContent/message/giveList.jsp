...
<body>
	...
	<tr>
		<td colspan="2" align="center"><h2>보낸 쪽지함</h2></td>
	</tr>
		<tr height="450px">
			<td class=t1 width="200px">
				<table border="0" width="100%" id="hh" >
					...
					<input type="hidden" name="msg_take" value="${session_ID }" />
				</td>
					</tr>
					<tr>
					<td align="center"><a href="javascript:location.href='Msg_Rec_list.action'" id="h2_grey"> <img src="/bts/icon/msg.png" width="20px"/> 받은쪽지함</a></td>
					</tr>
					<tr>
					<td  align="center"><a href="javascript:location.href='Msg_Wrt_list.action'" id="h2_grey"><img src="/bts/icon/msg.png" width="20px"/> <strong>보낸쪽지함</strong></a></td>
					</tr>
					<tr>
					<td height="450px">
					</td>
