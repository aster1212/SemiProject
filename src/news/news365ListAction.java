...
public class news365ListAction extends ActionSupport {
 ...
 public news365ListAction()throws IOException{
 ...
 public String execute() throws Exception{
	...
	// 모든 글을 가져와 list에 넣는다.
	list = sqlMapper.queryForList("selectAll-365day");
	
	
	//전체 글 갯수를 구한다.
	totalCount = list.size(); 
	
	//pagingAction365 객체 생성
	page = new pagingAction365(currentPage, totalCount, blockCount, blockPage); 
...
public pagingAction365 getPage() {
	return page;
}

public void setPage(pagingAction365 page) {
	this.page = page;
}
