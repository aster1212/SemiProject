...
public class moviePagingAction {
	...
	//추가하기 -mv_state
	public moviePagingAction(int currentPage, int totalCount, int blockCount,
		...
		if (currentPage > blockPage) {
			pagingHtml.append("<a href=movieList.action?currentPage="
