...
public class comingMoviePagingAction {
	...
	//추가하기 -mv_state
	public comingMoviePagingAction(int currentPage, int totalCount, int blockCount,
		...
		if (currentPage > blockPage) {
			pagingHtml.append("<a href=upMovieList.action?currentPage="
